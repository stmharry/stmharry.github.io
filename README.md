...
- Public site shows highlighted experience with an expandable reverse-chronological full-history view plus a curated publication subset
...
- Experience section shows highlighted entries first and uses a See more/See less control to reveal the full applied-variant history in reverse chronological order
