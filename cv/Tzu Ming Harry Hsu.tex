...
\begin{cvskills}{0.7cm}{15.7cm}
    \cvskill{1}{\textbf{1.5} years of experience in deep learning model deployment for Bite! APP}
    \cvskill{2}{\textbf{2} majors acquired in undergraduate education}
    \cvskill{3}{Ranked \textbf{\#1} in International Physics Olympiad 2011 in both theory and experiment}
\end{cvskills}
